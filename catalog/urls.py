...
urlpatterns = [
    ...
    path('<slug:category_slug>/', views.posts_list_category, name="posts_list_category"),
    path('<slug:category_slug>/<slug:topic_slug>/', views.posts_list_topic, name="posts_list_topic"),
]
